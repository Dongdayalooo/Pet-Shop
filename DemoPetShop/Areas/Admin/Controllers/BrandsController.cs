...
namespace DemoPetShop.Areas.Admin.Controllers
{
    ...
    public class BrandsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BrandId,BrandName,BrandImage,BrandDescription,Active")] Brand brand)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BrandId,BrandName,BrandImage,BrandDescription,Active")] Brand brand)
        {
            if (id != brand.BrandId)
            {
                return NotFound();
